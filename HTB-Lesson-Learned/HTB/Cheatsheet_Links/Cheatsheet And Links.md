...
3.  [Samba](#Samba)
	...
	2.4  [`Connecting using smbclient with Credentials`](#`Connecting%20using%20smbclient%20with%20Credentials`)
	...
	2.12 [`Get a Reverse shell using smbmap. Make sure python server and nc listener is running.`](#`Get%20a%20Reverse%20shell%20using%20smbmap.%20Make%20sure%20python%20server%20and%20nc%20listener%20is%20running.`)
3.  [CURL](#CURL)
